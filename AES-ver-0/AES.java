...
public class AES {
    ...
    // Método principal para probar la funcionalidad de cifrado y descifrado
    public static void main(String[] args) {
        String msgs[] = {
            "Lorem ipsum dicet",
            "Hola Andrés cómo está tu cuñado",
            "Àgora ïlla Ôtto"
        }; // Lista de mensajes para cifrar y descifrar.
        ...
        for (int i = 0; i < msgs.length; i++) {
            ...
            String desxifrat = "";
            try {
                bXifrats = xifraAES(msg, CLAU); // Cifra el mensaje usando la clave secreta.
                desxifrat = desxifraAES(bXifrats, CLAU); // Descifra el mensaje cifrado.
            } catch (Exception e) {
                System.err.println("Error de xifrat: " + e.getLocalizedMessage()); // Maneja cualquier error que ocurra durante el cifrado o descifrado.
            }
            // Imprime el mensaje original, el mensaje cifrado y el mensaje descifrado
            System.out.println("--------------------");
